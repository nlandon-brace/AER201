   ; Final Code :) 
   ; Initial Version...
   ; With ADC conversion and light test subroutine
   ; Checking Tray Switches Work
   ; Input from the IR_Sensor Mux works
   ; ADC remains to be tested...
   ; February 17, 2014
...
LED_TEST
    ...
    bank0
    movwf   voltage_temp
    movlw   b'10100'    ; setting the threshold to be 0.1 V
